...
setup(
    ...
    install_requires=["aiohttp>=3.8.4", "pydantic==1.10.2", "requests>=2.31.0", "tqdm>=4.64.1"],
    extras_require={"langchain": ["langchain>=0.0.306"], "sagemaker": ["boto3>=1.28.66", "botocore>=1.31.66"]},
